...
- **Doğrudan Bitki Türü Odağı:** Hastalık lekeleri, gürültüler eller veya arka plandaki yabani otlara takılmaksızın, doğrudan ana yaprağın karakteristik özelliklerinden bitki sınıfını ayırt eder.
...
- **Saha Tipi Optimizasyon:** Gerçek zamanlı mobil ve saha uygulamalarına entegre edilmeye uygun, son derece düşük gecikme süreli (low latency) çıkarım (inference) yeteneği.
